...
SECRET_KEY = 'django-insecure-dbuc5@&%rlet+h2hqc%e4^522vfcx1b1ppy-w9_ns%j$ejps62'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'note_app/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '',  # Mot de passe MySQL par défaut
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
